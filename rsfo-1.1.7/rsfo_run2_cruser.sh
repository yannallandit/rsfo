...
ora_profile=/opt/hpe/rsfo/ora_profile

# ./grid_profile : file provided with this script, template of .bash_profile
grid_profile=/opt/hpe/rsfo/grid_profile
...
echo
echo "################################################"
echo "$(tput smul)The script will now create the Oracle user"
...
then
  echo
  echo "################################################"
  echo "$(tput smul)The script will now Change gid for hugepages access"
  echo "on all nodes of your cluster.$(tput rmul)"
  echo
...
echo
echo "################################################"
echo "$(tput smul)RSFO will now update the /etc/profile file"
echo "on all nodes of your cluster.$(tput rmul)"
echo
...
echo
echo "################################################"
echo "$(tput smul)The script will now enable ssh for the Oracle user"
echo "on all nodes of your cluster.$(tput rmul)"
echo
...
echo
echo "################################################"
echo "$(tput smul)The script will now enable ssh for the Grid user"
echo "on all nodes of your cluster.$(tput rmul)"
echo
...
echo
echo "################################################"
echo "$(tput rev)Job done, Boss!!!$(tput sgr 0)"
echo "################################################"
echo ""
